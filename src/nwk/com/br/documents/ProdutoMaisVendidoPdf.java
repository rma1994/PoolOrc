...
import nwk.com.br.model.Produto;
    ...
    public class ProdutoMaisVendidoPdf {
        ...
        private PdfPTable getProduto() throws Exception{
            ...
            produtoMaisVendido.setWidthPercentage(100.0f);//seta o tamanho da tabela em relaçao ao documento
            ...
            PdfPCell descProduto = new PdfPCell(new Paragraph("Descrição"));
