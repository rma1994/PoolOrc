...
public class EscolhaConsulta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Escolha de Consulta");

        jButton1.setText("Cliente Que Mais Comprou");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ClienteMaisComprouPdf cliPdf = new ClienteMaisComprouPdf();
        
        try{
            cliPdf.getClienteMaisComprou();
        }catch(Exception e){
